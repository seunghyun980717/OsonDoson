#!/usr/bin/env python3
"""Create word-viewer QA JSON files with TCN v1 sequence estimated_3d blocks.
...
DEFAULT_CHECKPOINT = THREE_D_ROOT / "hand_lifting" / "runs" / "tcn_v1_sequence" / "hand_lifting_tcn_v1_best.pt"
DEFAULT_MANIFEST = THREE_D_ROOT / "hand_lifting" / "runs" / "tcn_v1_sequence" / "tcn_v1_sequence_viewer_qa_manifest.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prefix", default="tcn_v1_sequence_QA_full")
    parser.add_argument(
        "--match-prefix",
...
def build_estimated_word(
    ...
    spaces["estimated_3d"] = {
        "available": True,
        "coordinate_space": "viewer_normalized_xy_with_hand_lifting_tcn_v1_sequence_z",
    }
    spaces["depth_source"] = "estimated_3d"
    processing["estimated_3d_method"] = "hand_lifting_tcn_v1_sequence"
    ...
    payload["viewer_qa_alias"] = {
        ...
        "purpose": "hand_lifting_tcn_v1_sequence_estimated_3d_word_viewer_qa",
