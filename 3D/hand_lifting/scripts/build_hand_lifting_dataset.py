#!/usr/bin/env python3
"""Build hand-lifting training rows from AIHub keypoints and quality masks.
...
The dataset keeps the quality mask target-oriented. A frame can train wrist or
palm depth even when finger depth is rejected.
"""
...
def main() -> int:
    ...
    summary = {
        "config": {
            ...
            "label_units": "root-relative z normalized by 3D shoulder width",
        },
